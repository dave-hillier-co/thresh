...
orleansTest.excluded(
  ...
  "Tester.StreamingTests.PlugableQueueBalancerTests.PluggableQueueBalancerTestsWithMemoryStreamProvider.PluggableQueueBalancerTest_ShouldUseInjectedQueueBalancerAndBalanceCorrectly",
);

...
- **Maintain `todo.md`.** Track outstanding work items in `todo.md` at the repo root. Add items as
  ...
  reflects the real state of the work; group items by the phase they belong to in
  [`docs/13-roadmap-and-phases.md`](docs/13-roadmap-and-phases.md).
- **Work test-first (TDD).** Write a failing test that describes the desired behaviour before
  ...
  [`docs/12-project-structure-and-tooling.md`](docs/12-project-structure-and-tooling.md).
